...
class Ieee1609Dot2CrlBaseTypes:

    _name_  = 'Ieee1609Dot2CrlBaseTypes'
    _oid_   = [1, 3, 111, 2, 1609, 2, 3, 2, 3, 2]
    ...
    #-----< CrlContents >-----#
    CrlContents = SEQ(name='CrlContents', mode=MODE_TYPE)
    _CrlContents_version = INT(name='version', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Uint8')))
    _CrlContents_version._const_val = ASN1Set(rv=[1], rr=[], ev=None, er=[])
    _CrlContents_crlSeries = INT(name='crlSeries', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'CrlSeries')))
    _CrlContents_crlCraca = OCT_STR(name='crlCraca', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'HashedId8')))
    _CrlContents_issueDate = INT(name='issueDate', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Time32')))
    _CrlContents_nextCrl = INT(name='nextCrl', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Time32')))
    _CrlContents_priorityInfo = SEQ(name='priorityInfo', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'CrlPriorityInfo')))
    _CrlContents_typeSpecific = CHOICE(name='typeSpecific', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'TypeSpecificCrlContents')))
    CrlContents._cont = ASN1Dict([
        ('version', _CrlContents_version),
        ('crlSeries', _CrlContents_crlSeries),
        ('crlCraca', _CrlContents_crlCraca),
        ('issueDate', _CrlContents_issueDate),
        ('nextCrl', _CrlContents_nextCrl),
        ('priorityInfo', _CrlContents_priorityInfo),
        ('typeSpecific', _CrlContents_typeSpecific),
        ])
    CrlContents._ext = None
    
    #-----< CrlPriorityInfo >-----#
    CrlPriorityInfo = SEQ(name='CrlPriorityInfo', mode=MODE_TYPE)
    _CrlPriorityInfo_priority = INT(name='priority', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Uint8')), opt=True)
    CrlPriorityInfo._cont = ASN1Dict([
        ('priority', _CrlPriorityInfo_priority),
        ])
    CrlPriorityInfo._ext = []
    
    #-----< TypeSpecificCrlContents >-----#
    TypeSpecificCrlContents = CHOICE(name='TypeSpecificCrlContents', mode=MODE_TYPE)
    _TypeSpecificCrlContents_fullHashCrl = SEQ(name='fullHashCrl', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'ToBeSignedHashIdCrl')))
    _TypeSpecificCrlContents_deltaHashCrl = SEQ(name='deltaHashCrl', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'ToBeSignedHashIdCrl')))
    _TypeSpecificCrlContents_fullLinkedCrl = SEQ(name='fullLinkedCrl', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'ToBeSignedLinkageValueCrl')))
    _TypeSpecificCrlContents_deltaLinkedCrl = SEQ(name='deltaLinkedCrl', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'ToBeSignedLinkageValueCrl')))
    _TypeSpecificCrlContents_fullLinkedCrlWithAlg = SEQ(name='fullLinkedCrlWithAlg', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'ToBeSignedLinkageValueCrlWithAlgIdentifier')))
    _TypeSpecificCrlContents_deltaLinkedCrlWithAlg = SEQ(name='deltaLinkedCrlWithAlg', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'ToBeSignedLinkageValueCrlWithAlgIdentifier')))
    TypeSpecificCrlContents._cont = ASN1Dict([
        ('fullHashCrl', _TypeSpecificCrlContents_fullHashCrl),
        ('deltaHashCrl', _TypeSpecificCrlContents_deltaHashCrl),
        ('fullLinkedCrl', _TypeSpecificCrlContents_fullLinkedCrl),
        ('deltaLinkedCrl', _TypeSpecificCrlContents_deltaLinkedCrl),
        ('fullLinkedCrlWithAlg', _TypeSpecificCrlContents_fullLinkedCrlWithAlg),
        ('deltaLinkedCrlWithAlg', _TypeSpecificCrlContents_deltaLinkedCrlWithAlg),
        ])
    TypeSpecificCrlContents._ext = ['fullLinkedCrlWithAlg', 'deltaLinkedCrlWithAlg']
    
    #-----< ToBeSignedHashIdCrl >-----#
    ToBeSignedHashIdCrl = SEQ(name='ToBeSignedHashIdCrl', mode=MODE_TYPE)
    _ToBeSignedHashIdCrl_crlSerial = INT(name='crlSerial', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Uint32')))
    _ToBeSignedHashIdCrl_entries = SEQ_OF(name='entries', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'SequenceOfHashBasedRevocationInfo')))
    ToBeSignedHashIdCrl._cont = ASN1Dict([
        ('crlSerial', _ToBeSignedHashIdCrl_crlSerial),
        ('entries', _ToBeSignedHashIdCrl_entries),
        ])
    ToBeSignedHashIdCrl._ext = []
    
    #-----< SequenceOfHashBasedRevocationInfo >-----#
    SequenceOfHashBasedRevocationInfo = SEQ_OF(name='SequenceOfHashBasedRevocationInfo', mode=MODE_TYPE)
    _SequenceOfHashBasedRevocationInfo__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'HashBasedRevocationInfo')))
    SequenceOfHashBasedRevocationInfo._cont = _SequenceOfHashBasedRevocationInfo__item_
    
    #-----< HashBasedRevocationInfo >-----#
    HashBasedRevocationInfo = SEQ(name='HashBasedRevocationInfo', mode=MODE_TYPE)
    _HashBasedRevocationInfo_id = OCT_STR(name='id', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'HashedId10')))
    _HashBasedRevocationInfo_expiry = INT(name='expiry', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Time32')))
    HashBasedRevocationInfo._cont = ASN1Dict([
        ('id', _HashBasedRevocationInfo_id),
        ('expiry', _HashBasedRevocationInfo_expiry),
        ])
    HashBasedRevocationInfo._ext = []
    
    #-----< ToBeSignedLinkageValueCrl >-----#
    ToBeSignedLinkageValueCrl = SEQ(name='ToBeSignedLinkageValueCrl', mode=MODE_TYPE)
    _ToBeSignedLinkageValueCrl_iRev = INT(name='iRev', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'IValue')))
    _ToBeSignedLinkageValueCrl_indexWithinI = INT(name='indexWithinI', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Uint8')))
    _ToBeSignedLinkageValueCrl_individual = SEQ_OF(name='individual', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'SequenceOfJMaxGroup')), opt=True)
    _ToBeSignedLinkageValueCrl_groups = SEQ_OF(name='groups', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'SequenceOfGroupCrlEntry')), opt=True)
    _ToBeSignedLinkageValueCrl_groupsSingleSeed = SEQ_OF(name='groupsSingleSeed', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'SequenceOfGroupSingleSeedCrlEntry')), opt=True)
    ToBeSignedLinkageValueCrl._cont = ASN1Dict([
        ('iRev', _ToBeSignedLinkageValueCrl_iRev),
        ('indexWithinI', _ToBeSignedLinkageValueCrl_indexWithinI),
        ('individual', _ToBeSignedLinkageValueCrl_individual),
        ('groups', _ToBeSignedLinkageValueCrl_groups),
        ('groupsSingleSeed', _ToBeSignedLinkageValueCrl_groupsSingleSeed),
        ])
    ToBeSignedLinkageValueCrl._ext = ['groupsSingleSeed']
    
    #-----< SequenceOfJMaxGroup >-----#
    SequenceOfJMaxGroup = SEQ_OF(name='SequenceOfJMaxGroup', mode=MODE_TYPE)
    _SequenceOfJMaxGroup__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'JMaxGroup')))
    SequenceOfJMaxGroup._cont = _SequenceOfJMaxGroup__item_
    
    #-----< JMaxGroup >-----#
    JMaxGroup = SEQ(name='JMaxGroup', mode=MODE_TYPE)
    _JMaxGroup_jmax = INT(name='jmax', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Uint8')))
    _JMaxGroup_contents = SEQ_OF(name='contents', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'SequenceOfLAGroup')))
    JMaxGroup._cont = ASN1Dict([
        ('jmax', _JMaxGroup_jmax),
        ('contents', _JMaxGroup_contents),
        ])
    JMaxGroup._ext = []
    
    #-----< SequenceOfLAGroup >-----#
    SequenceOfLAGroup = SEQ_OF(name='SequenceOfLAGroup', mode=MODE_TYPE)
    _SequenceOfLAGroup__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'LAGroup')))
    SequenceOfLAGroup._cont = _SequenceOfLAGroup__item_
    
    #-----< LAGroup >-----#
    LAGroup = SEQ(name='LAGroup', mode=MODE_TYPE)
    _LAGroup_la1Id = OCT_STR(name='la1Id', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'LaId')))
    _LAGroup_la2Id = OCT_STR(name='la2Id', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'LaId')))
    _LAGroup_contents = SEQ_OF(name='contents', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'SequenceOfIMaxGroup')))
    LAGroup._cont = ASN1Dict([
        ('la1Id', _LAGroup_la1Id),
        ('la2Id', _LAGroup_la2Id),
        ('contents', _LAGroup_contents),
        ])
    LAGroup._ext = []
    
    #-----< SequenceOfIMaxGroup >-----#
    SequenceOfIMaxGroup = SEQ_OF(name='SequenceOfIMaxGroup', mode=MODE_TYPE)
    _SequenceOfIMaxGroup__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'IMaxGroup')))
    SequenceOfIMaxGroup._cont = _SequenceOfIMaxGroup__item_
    
    #-----< IMaxGroup >-----#
    IMaxGroup = SEQ(name='IMaxGroup', mode=MODE_TYPE)
    _IMaxGroup_iMax = INT(name='iMax', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Uint16')))
    _IMaxGroup_contents = SEQ_OF(name='contents', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'SequenceOfIndividualRevocation')))
    _IMaxGroup_singleSeed = SEQ_OF(name='singleSeed', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'SequenceOfLinkageSeed')), opt=True)
    IMaxGroup._cont = ASN1Dict([
        ('iMax', _IMaxGroup_iMax),
        ('contents', _IMaxGroup_contents),
        ('singleSeed', _IMaxGroup_singleSeed),
        ])
    IMaxGroup._ext = ['singleSeed']
    
    #-----< SequenceOfIndividualRevocation >-----#
    SequenceOfIndividualRevocation = SEQ_OF(name='SequenceOfIndividualRevocation', mode=MODE_TYPE)
    _SequenceOfIndividualRevocation__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'IndividualRevocation')))
    SequenceOfIndividualRevocation._cont = _SequenceOfIndividualRevocation__item_
    SequenceOfIndividualRevocation._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=None)], ev=None, er=[])
    
    #-----< IndividualRevocation >-----#
    IndividualRevocation = SEQ(name='IndividualRevocation', mode=MODE_TYPE)
    _IndividualRevocation_linkageSeed1 = OCT_STR(name='linkageSeed1', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'LinkageSeed')))
    _IndividualRevocation_linkageSeed2 = OCT_STR(name='linkageSeed2', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'LinkageSeed')))
    IndividualRevocation._cont = ASN1Dict([
        ('linkageSeed1', _IndividualRevocation_linkageSeed1),
        ('linkageSeed2', _IndividualRevocation_linkageSeed2),
        ])
    IndividualRevocation._ext = []
    
    #-----< SequenceOfGroupCrlEntry >-----#
    SequenceOfGroupCrlEntry = SEQ_OF(name='SequenceOfGroupCrlEntry', mode=MODE_TYPE)
    _SequenceOfGroupCrlEntry__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'GroupCrlEntry')))
    SequenceOfGroupCrlEntry._cont = _SequenceOfGroupCrlEntry__item_
    
    #-----< GroupCrlEntry >-----#
    GroupCrlEntry = SEQ(name='GroupCrlEntry', mode=MODE_TYPE)
    _GroupCrlEntry_iMax = INT(name='iMax', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Uint16')))
    _GroupCrlEntry_la1Id = OCT_STR(name='la1Id', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'LaId')))
    _GroupCrlEntry_linkageSeed1 = OCT_STR(name='linkageSeed1', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'LinkageSeed')))
    _GroupCrlEntry_la2Id = OCT_STR(name='la2Id', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'LaId')))
    _GroupCrlEntry_linkageSeed2 = OCT_STR(name='linkageSeed2', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'LinkageSeed')))
    GroupCrlEntry._cont = ASN1Dict([
        ('iMax', _GroupCrlEntry_iMax),
        ('la1Id', _GroupCrlEntry_la1Id),
        ('linkageSeed1', _GroupCrlEntry_linkageSeed1),
        ('la2Id', _GroupCrlEntry_la2Id),
        ('linkageSeed2', _GroupCrlEntry_linkageSeed2),
        ])
    GroupCrlEntry._ext = []
    
    #-----< ToBeSignedLinkageValueCrlWithAlgIdentifier >-----#
    ToBeSignedLinkageValueCrlWithAlgIdentifier = SEQ(name='ToBeSignedLinkageValueCrlWithAlgIdentifier', mode=MODE_TYPE)
    _ToBeSignedLinkageValueCrlWithAlgIdentifier_iRev = INT(name='iRev', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'IValue')))
    _ToBeSignedLinkageValueCrlWithAlgIdentifier_indexWithinI = INT(name='indexWithinI', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Uint8')))
    _ToBeSignedLinkageValueCrlWithAlgIdentifier_seedEvolution = NULL(name='seedEvolution', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'SeedEvolutionFunctionIdentifier')))
    _ToBeSignedLinkageValueCrlWithAlgIdentifier_lvGeneration = NULL(name='lvGeneration', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'LvGenerationFunctionIdentifier')))
    _ToBeSignedLinkageValueCrlWithAlgIdentifier_individual = SEQ_OF(name='individual', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'SequenceOfJMaxGroup')), opt=True)
    _ToBeSignedLinkageValueCrlWithAlgIdentifier_groups = SEQ_OF(name='groups', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'SequenceOfGroupCrlEntry')), opt=True)
    _ToBeSignedLinkageValueCrlWithAlgIdentifier_groupsSingleSeed = SEQ_OF(name='groupsSingleSeed', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'SequenceOfGroupSingleSeedCrlEntry')), opt=True)
    ToBeSignedLinkageValueCrlWithAlgIdentifier._cont = ASN1Dict([
        ('iRev', _ToBeSignedLinkageValueCrlWithAlgIdentifier_iRev),
        ('indexWithinI', _ToBeSignedLinkageValueCrlWithAlgIdentifier_indexWithinI),
        ('seedEvolution', _ToBeSignedLinkageValueCrlWithAlgIdentifier_seedEvolution),
        ('lvGeneration', _ToBeSignedLinkageValueCrlWithAlgIdentifier_lvGeneration),
        ('individual', _ToBeSignedLinkageValueCrlWithAlgIdentifier_individual),
        ('groups', _ToBeSignedLinkageValueCrlWithAlgIdentifier_groups),
        ('groupsSingleSeed', _ToBeSignedLinkageValueCrlWithAlgIdentifier_groupsSingleSeed),
        ])
    ToBeSignedLinkageValueCrlWithAlgIdentifier._ext = []
    
    #-----< SequenceOfGroupSingleSeedCrlEntry >-----#
    SequenceOfGroupSingleSeedCrlEntry = SEQ_OF(name='SequenceOfGroupSingleSeedCrlEntry', mode=MODE_TYPE)
    _SequenceOfGroupSingleSeedCrlEntry__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2CrlBaseTypes', 'GroupSingleSeedCrlEntry')))
    SequenceOfGroupSingleSeedCrlEntry._cont = _SequenceOfGroupSingleSeedCrlEntry__item_
    
    #-----< GroupSingleSeedCrlEntry >-----#
    GroupSingleSeedCrlEntry = SEQ(name='GroupSingleSeedCrlEntry', mode=MODE_TYPE)
    _GroupSingleSeedCrlEntry_iMax = INT(name='iMax', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Uint16')))
    _GroupSingleSeedCrlEntry_laId = OCT_STR(name='laId', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'LaId')))
    _GroupSingleSeedCrlEntry_linkageSeed = OCT_STR(name='linkageSeed', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'LinkageSeed')))
    GroupSingleSeedCrlEntry._cont = ASN1Dict([
        ('iMax', _GroupSingleSeedCrlEntry_iMax),
        ('laId', _GroupSingleSeedCrlEntry_laId),
        ('linkageSeed', _GroupSingleSeedCrlEntry_linkageSeed),
        ])
    GroupSingleSeedCrlEntry._ext = None
    
    #-----< ExpansionAlgorithmIdentifier >-----#
    ExpansionAlgorithmIdentifier = ENUM(name='ExpansionAlgorithmIdentifier', mode=MODE_TYPE)
    ExpansionAlgorithmIdentifier._cont = ASN1Dict([('sha256ForI-aesForJ', 0), ('sm3ForI-sm4ForJ', 1)])
    ExpansionAlgorithmIdentifier._ext = []
    
    #-----< SeedEvolutionFunctionIdentifier >-----#
    SeedEvolutionFunctionIdentifier = NULL(name='SeedEvolutionFunctionIdentifier', mode=MODE_TYPE)
    
    #-----< LvGenerationFunctionIdentifier >-----#
    LvGenerationFunctionIdentifier = NULL(name='LvGenerationFunctionIdentifier', mode=MODE_TYPE)
    
    _all_ = [
        _CrlContents_version,
        _CrlContents_crlSeries,
        _CrlContents_crlCraca,
        _CrlContents_issueDate,
        _CrlContents_nextCrl,
        _CrlContents_priorityInfo,
        _CrlContents_typeSpecific,
        CrlContents,
        _CrlPriorityInfo_priority,
        CrlPriorityInfo,
        _TypeSpecificCrlContents_fullHashCrl,
        _TypeSpecificCrlContents_deltaHashCrl,
        _TypeSpecificCrlContents_fullLinkedCrl,
        _TypeSpecificCrlContents_deltaLinkedCrl,
        _TypeSpecificCrlContents_fullLinkedCrlWithAlg,
        _TypeSpecificCrlContents_deltaLinkedCrlWithAlg,
        TypeSpecificCrlContents,
        _ToBeSignedHashIdCrl_crlSerial,
        _ToBeSignedHashIdCrl_entries,
        ToBeSignedHashIdCrl,
        _SequenceOfHashBasedRevocationInfo__item_,
        SequenceOfHashBasedRevocationInfo,
        _HashBasedRevocationInfo_id,
        _HashBasedRevocationInfo_expiry,
        HashBasedRevocationInfo,
        _ToBeSignedLinkageValueCrl_iRev,
        _ToBeSignedLinkageValueCrl_indexWithinI,
        _ToBeSignedLinkageValueCrl_individual,
        _ToBeSignedLinkageValueCrl_groups,
        _ToBeSignedLinkageValueCrl_groupsSingleSeed,
        ToBeSignedLinkageValueCrl,
        _SequenceOfJMaxGroup__item_,
        SequenceOfJMaxGroup,
        _JMaxGroup_jmax,
        _JMaxGroup_contents,
        JMaxGroup,
        _SequenceOfLAGroup__item_,
        SequenceOfLAGroup,
        _LAGroup_la1Id,
        _LAGroup_la2Id,
        _LAGroup_contents,
        LAGroup,
        _SequenceOfIMaxGroup__item_,
        SequenceOfIMaxGroup,
        _IMaxGroup_iMax,
        _IMaxGroup_contents,
        _IMaxGroup_singleSeed,
        IMaxGroup,
        _SequenceOfIndividualRevocation__item_,
        SequenceOfIndividualRevocation,
        _IndividualRevocation_linkageSeed1,
        _IndividualRevocation_linkageSeed2,
        IndividualRevocation,
        _SequenceOfGroupCrlEntry__item_,
        SequenceOfGroupCrlEntry,
        _GroupCrlEntry_iMax,
        _GroupCrlEntry_la1Id,
        _GroupCrlEntry_linkageSeed1,
        _GroupCrlEntry_la2Id,
        _GroupCrlEntry_linkageSeed2,
        GroupCrlEntry,
        _ToBeSignedLinkageValueCrlWithAlgIdentifier_iRev,
        _ToBeSignedLinkageValueCrlWithAlgIdentifier_indexWithinI,
        _ToBeSignedLinkageValueCrlWithAlgIdentifier_seedEvolution,
        _ToBeSignedLinkageValueCrlWithAlgIdentifier_lvGeneration,
        _ToBeSignedLinkageValueCrlWithAlgIdentifier_individual,
        _ToBeSignedLinkageValueCrlWithAlgIdentifier_groups,
        _ToBeSignedLinkageValueCrlWithAlgIdentifier_groupsSingleSeed,
        ToBeSignedLinkageValueCrlWithAlgIdentifier,
        _SequenceOfGroupSingleSeedCrlEntry__item_,
        SequenceOfGroupSingleSeedCrlEntry,
        _GroupSingleSeedCrlEntry_iMax,
        _GroupSingleSeedCrlEntry_laId,
        _GroupSingleSeedCrlEntry_linkageSeed,
        GroupSingleSeedCrlEntry,
        ExpansionAlgorithmIdentifier,
        SeedEvolutionFunctionIdentifier,
        LvGenerationFunctionIdentifier,
...
class Ieee1609Dot2BaseTypes:
    ...
    _oid_   = [1, 3, 111, 2, 1609, 2, 1, 2, 2, 4]
    ...
    #-----< HashedId48 >-----#
    HashedId48 = OCT_STR(name='HashedId48', mode=MODE_TYPE)
    HashedId48._const_sz = ASN1Set(rv=[48], rr=[], ev=None, er=[])
    ...
    _IdentifiedRegion_countryOnly = INT(name='countryOnly', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'UnCountryId')))
    ...
    #-----< UnCountryId >-----#
    UnCountryId = INT(name='UnCountryId', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Uint16')))
    
    #-----< CountryOnly >-----#
    CountryOnly = INT(name='CountryOnly', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'UnCountryId')))
    
    #-----< CountryAndRegions >-----#
    CountryAndRegions = SEQ(name='CountryAndRegions', mode=MODE_TYPE)
    _CountryAndRegions_countryOnly = INT(name='countryOnly', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'UnCountryId')))
    ...
    _CountryAndSubregions_countryOnly = INT(name='countryOnly', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'UnCountryId')))
    ...
    CountryAndSubregions._cont = ASN1Dict([
        ('countryOnly', _CountryAndSubregions_countryOnly),
    ...
    _Signature_ecdsaNistP384Signature = SEQ(name='ecdsaNistP384Signature', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'EcdsaP384Signature')))
    _Signature_sm2Signature = SEQ(name='sm2Signature', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'EcsigP256Signature')))
    Signature._cont = ASN1Dict([
        ...
        ('ecdsaNistP384Signature', _Signature_ecdsaNistP384Signature),
        ('sm2Signature', _Signature_sm2Signature),
        ])
    Signature._ext = ['ecdsaBrainpoolP384r1Signature', 'ecdsaNistP384Signature', 'sm2Signature']
    ...
    #-----< EcsigP256Signature >-----#
    EcsigP256Signature = SEQ(name='EcsigP256Signature', mode=MODE_TYPE)
    _EcsigP256Signature_rSig = OCT_STR(name='rSig', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EcsigP256Signature_rSig._const_sz = ASN1Set(rv=[32], rr=[], ev=None, er=[])
    _EcsigP256Signature_sSig = OCT_STR(name='sSig', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EcsigP256Signature_sSig._const_sz = ASN1Set(rv=[32], rr=[], ev=None, er=[])
    EcsigP256Signature._cont = ASN1Dict([
        ('rSig', _EcsigP256Signature_rSig),
        ('sSig', _EcsigP256Signature_sSig),
        ])
    EcsigP256Signature._ext = None
    ...
    SymmAlgorithm._cont = ASN1Dict([('aes128Ccm', 0), ('sm4Ccm', 1)])
    SymmAlgorithm._ext = ['sm4Ccm']
    
    #-----< HashAlgorithm >-----#
    HashAlgorithm = ENUM(name='HashAlgorithm', mode=MODE_TYPE)
    HashAlgorithm._cont = ASN1Dict([('sha256', 0), ('sha384', 1), ('sm3', 2)])
    HashAlgorithm._ext = ['sha384', 'sm3']
    ...
    #-----< EcencP256EncryptedKey >-----#
    EcencP256EncryptedKey = SEQ(name='EcencP256EncryptedKey', mode=MODE_TYPE)
    _EcencP256EncryptedKey_v = CHOICE(name='v', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'EccP256CurvePoint')))
    _EcencP256EncryptedKey_c = OCT_STR(name='c', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EcencP256EncryptedKey_c._const_sz = ASN1Set(rv=[16], rr=[], ev=None, er=[])
    _EcencP256EncryptedKey_t = OCT_STR(name='t', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EcencP256EncryptedKey_t._const_sz = ASN1Set(rv=[32], rr=[], ev=None, er=[])
    EcencP256EncryptedKey._cont = ASN1Dict([
        ('v', _EcencP256EncryptedKey_v),
        ('c', _EcencP256EncryptedKey_c),
        ('t', _EcencP256EncryptedKey_t),
        ])
    EcencP256EncryptedKey._ext = None
    ...
    _BasePublicEncryptionKey_ecencSm2 = CHOICE(name='ecencSm2', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'EccP256CurvePoint')))
    BasePublicEncryptionKey._cont = ASN1Dict([
        ...
        ('ecencSm2', _BasePublicEncryptionKey_ecencSm2),
        ])
    BasePublicEncryptionKey._ext = ['ecencSm2']
    ...
    _PublicVerificationKey_ecdsaNistP384 = CHOICE(name='ecdsaNistP384', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'EccP384CurvePoint')))
    _PublicVerificationKey_ecsigSm2 = CHOICE(name='ecsigSm2', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'EccP256CurvePoint')))
    PublicVerificationKey._cont = ASN1Dict([
        ...
        ('ecdsaNistP384', _PublicVerificationKey_ecdsaNistP384),
        ('ecsigSm2', _PublicVerificationKey_ecsigSm2),
        ])
    PublicVerificationKey._ext = ['ecdsaBrainpoolP384r1', 'ecdsaNistP384', 'ecsigSm2']
    ...
    _SymmetricEncryptionKey_sm4Ccm = OCT_STR(name='sm4Ccm', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _SymmetricEncryptionKey_sm4Ccm._const_sz = ASN1Set(rv=[16], rr=[], ev=None, er=[])
    SymmetricEncryptionKey._cont = ASN1Dict([
        ('aes128Ccm', _SymmetricEncryptionKey_aes128Ccm),
        ('sm4Ccm', _SymmetricEncryptionKey_sm4Ccm),
        ])
    SymmetricEncryptionKey._ext = ['sm4Ccm']
    ...
    #-----< SequenceOfLinkageSeed >-----#
    SequenceOfLinkageSeed = SEQ_OF(name='SequenceOfLinkageSeed', mode=MODE_TYPE)
    _SequenceOfLinkageSeed__item_ = OCT_STR(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'LinkageSeed')))
    SequenceOfLinkageSeed._cont = _SequenceOfLinkageSeed__item_
    ...
    #-----< CERT-EXT-TYPE >-----#
    CERT_EXT_TYPE = CLASS(name='CERT-EXT-TYPE', mode=MODE_TYPE)
    _CERT_EXT_TYPE_id = INT(name='id', mode=MODE_VALUE, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'ExtId')))
    _CERT_EXT_TYPE_App = OPEN(name='App', mode=MODE_TYPE)
    _CERT_EXT_TYPE_Issue = OPEN(name='Issue', mode=MODE_TYPE)
    _CERT_EXT_TYPE_Req = OPEN(name='Req', mode=MODE_TYPE)
    CERT_EXT_TYPE._cont = ASN1Dict([
        ('id', _CERT_EXT_TYPE_id),
        ('App', _CERT_EXT_TYPE_App),
        ('Issue', _CERT_EXT_TYPE_Issue),
        ('Req', _CERT_EXT_TYPE_Req),
        ])
    ...
    _EXT_TYPE_extId = INT(name='extId', mode=MODE_VALUE, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'ExtId')))
    ...
    _all_ = [
        ...
        CountryAndRegions,
        _CountryAndSubregions_countryOnly,
        ...
        _Signature_ecdsaNistP384Signature,
        _Signature_sm2Signature,
        Signature,
        ...
        EcdsaP384Signature,
        _EcsigP256Signature_rSig,
        _EcsigP256Signature_sSig,
        EcsigP256Signature,
        ...
        EciesP256EncryptedKey,
        _EcencP256EncryptedKey_v,
        _EcencP256EncryptedKey_c,
        _EcencP256EncryptedKey_t,
        EcencP256EncryptedKey,
        ...
        _BasePublicEncryptionKey_ecencSm2,
        BasePublicEncryptionKey,
        ...
        _PublicVerificationKey_ecdsaNistP384,
        _PublicVerificationKey_ecsigSm2,
        PublicVerificationKey,
        _SymmetricEncryptionKey_aes128Ccm,
        _SymmetricEncryptionKey_sm4Ccm,
        SymmetricEncryptionKey,
        _PsidSsp_psid,
        _PsidSsp_ssp,
        PsidSsp,
        ...
        GroupLinkageValue,
        LaId,
        _SequenceOfLinkageSeed__item_,
        SequenceOfLinkageSeed,
        LinkageSeed,
        _CERT_EXT_TYPE_id,
        _CERT_EXT_TYPE_App,
        _CERT_EXT_TYPE_Issue,
        _CERT_EXT_TYPE_Req,
        CERT_EXT_TYPE,
        _EXT_TYPE_extId,
...
class EtsiTs103097ExtensionModule:
    ...
    #-----< EtsiOriginatingHeaderInfoExtension >-----#
    EtsiOriginatingHeaderInfoExtension = SEQ(name='EtsiOriginatingHeaderInfoExtension', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Extension')))
    _EtsiOriginatingHeaderInfoExtension_id = INT(name='id', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefClassField(('Ieee1609Dot2BaseTypes', 'EXT-TYPE'), ['extId']))
    __EtsiOriginatingHeaderInfoExtension_id_tab = CLASS(name='_tab_EXT-TYPE', mode=MODE_SET, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'EXT-TYPE')))
    ___EtsiOriginatingHeaderInfoExtension_id_tab_val_ExtContent_0 = NULL(name='ExtContent', mode=MODE_TYPE, typeref=ASN1RefType(('EtsiTs103097ExtensionModule', 'EtsiTs102941CrlRequest')))
    ___EtsiOriginatingHeaderInfoExtension_id_tab_val_ExtContent_1 = NULL(name='ExtContent', mode=MODE_TYPE, typeref=ASN1RefType(('EtsiTs103097ExtensionModule', 'EtsiTs102941DeltaCtlRequest')))
    ...
    _EtsiOriginatingHeaderInfoExtension_content = OPEN(name='content', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefClassField(('Ieee1609Dot2BaseTypes', 'EXT-TYPE'), ['ExtContent']))
    ...
    #-----< EtsiTs103097HeaderInfoExtensionId >-----#
    EtsiTs103097HeaderInfoExtensionId = INT(name='EtsiTs103097HeaderInfoExtensionId', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'ExtId')))
    ...
    #-----< EtsiTs103097HeaderInfoExtensions >-----#
    EtsiTs103097HeaderInfoExtensions = CLASS(name='EtsiTs103097HeaderInfoExtensions', mode=MODE_SET, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'EXT-TYPE')))
    _EtsiTs103097HeaderInfoExtensions_val_ExtContent_0 = NULL(name='ExtContent', mode=MODE_TYPE, typeref=ASN1RefType(('EtsiTs103097ExtensionModule', 'EtsiTs102941CrlRequest')))
    _EtsiTs103097HeaderInfoExtensions_val_ExtContent_1 = NULL(name='ExtContent', mode=MODE_TYPE, typeref=ASN1RefType(('EtsiTs103097ExtensionModule', 'EtsiTs102941DeltaCtlRequest')))
    ...
    #-----< EtsiTs102941CrlRequest >-----#
    EtsiTs102941CrlRequest = NULL(name='EtsiTs102941CrlRequest', mode=MODE_TYPE)
    
    #-----< EtsiTs102941CtlRequest >-----#
    EtsiTs102941CtlRequest = NULL(name='EtsiTs102941CtlRequest', mode=MODE_TYPE)
    
    #-----< EtsiTs102941DeltaCtlRequest >-----#
    EtsiTs102941DeltaCtlRequest = NULL(name='EtsiTs102941DeltaCtlRequest', mode=MODE_TYPE, typeref=ASN1RefType(('EtsiTs103097ExtensionModule', 'EtsiTs102941CtlRequest')))
...
class Ieee1609Dot2CrlSsp:

    _name_  = 'Ieee1609Dot2CrlSsp'
    _oid_   = [1, 3, 111, 2, 1609, 2, 3, 3, 2, 2]
    ...
    #-----< CrlSsp >-----#
    CrlSsp = SEQ(name='CrlSsp', mode=MODE_TYPE)
    _CrlSsp_version = INT(name='version', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Uint8')))
    _CrlSsp_version._const_val = ASN1Set(rv=[1], rr=[], ev=None, er=[])
    _CrlSsp_associatedCraca = ENUM(name='associatedCraca', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlSsp', 'CracaType')))
    _CrlSsp_crls = SEQ_OF(name='crls', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2CrlSsp', 'PermissibleCrls')))
    CrlSsp._cont = ASN1Dict([
        ('version', _CrlSsp_version),
        ('associatedCraca', _CrlSsp_associatedCraca),
        ('crls', _CrlSsp_crls),
        ])
    CrlSsp._ext = []
    
    #-----< CracaType >-----#
    CracaType = ENUM(name='CracaType', mode=MODE_TYPE)
    CracaType._cont = ASN1Dict([('isCraca', 0), ('issuerIsCraca', 1)])
    CracaType._ext = None
    
    #-----< PermissibleCrls >-----#
    PermissibleCrls = SEQ_OF(name='PermissibleCrls', mode=MODE_TYPE)
    _PermissibleCrls__item_ = INT(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'CrlSeries')))
    PermissibleCrls._cont = _PermissibleCrls__item_
    
    _all_ = [
        _CrlSsp_version,
        _CrlSsp_associatedCraca,
        _CrlSsp_crls,
        CrlSsp,
        CracaType,
        _PermissibleCrls__item_,
        PermissibleCrls,
    ]

class Ieee1609Dot2Crl:

    _name_  = 'Ieee1609Dot2Crl'
    _oid_   = [1, 3, 111, 2, 1609, 2, 3, 3, 2]
    ...
    #-----< CrlPsid >-----#
    CrlPsid = INT(name='CrlPsid', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Psid')))
    CrlPsid._const_val = ASN1Set(rv=[256], rr=[], ev=None, er=[])
    
    #-----< SecuredCrl >-----#
    SecuredCrl = SEQ(name='SecuredCrl', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2', 'Ieee1609Dot2Data')))
...
class Ieee1609Dot2:
    ...
    _name_  = 'Ieee1609Dot2'
    _oid_   = [1, 3, 111, 2, 1609, 2, 1, 1, 2, 6]
    ...
    _Ieee1609Dot2Content_signedX509CertificateRequest = OCT_STR(name='signedX509CertificateRequest', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Opaque')))
    Ieee1609Dot2Content._cont = ASN1Dict([
        ...
        ('signedX509CertificateRequest', _Ieee1609Dot2Content_signedX509CertificateRequest),
        ])
    Ieee1609Dot2Content._ext = ['signedX509CertificateRequest']
    ...
    _SignedDataPayload_omitted = NULL(name='omitted', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    SignedDataPayload._cont = ASN1Dict([
        ('data', _SignedDataPayload_data),
        ('extDataHash', _SignedDataPayload_extDataHash),
        ('omitted', _SignedDataPayload_omitted),
        ])
    SignedDataPayload._ext = ['omitted']
    
    #-----< HashedData >-----#
    HashedData = CHOICE(name='HashedData', mode=MODE_TYPE)
    _HashedData_sha256HashedData = OCT_STR(name='sha256HashedData', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'HashedId32')))
    _HashedData_sha384HashedData = OCT_STR(name='sha384HashedData', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'HashedId48')))
    _HashedData_sm3HashedData = OCT_STR(name='sm3HashedData', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'HashedId32')))
    HashedData._cont = ASN1Dict([
        ('sha256HashedData', _HashedData_sha256HashedData),
        ('sha384HashedData', _HashedData_sha384HashedData),
        ('sm3HashedData', _HashedData_sm3HashedData),
        ])
    HashedData._ext = ['sha384HashedData', 'sm3HashedData']
    ...
    #-----< iso21177SessionExtension >-----#
    iso21177SessionExtension = INT(name='iso21177SessionExtension', mode=MODE_VALUE, typeref=ASN1RefType(('Ieee1609Dot2', 'PduFunctionalType')))
    iso21177SessionExtension._val = 3
    ...
    ___ContributedExtensionBlock_contributorId_tab_val_Extn_0 = SEQ(name='Extn', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2', 'Ieee1609ContributedHeaderInfoExtension')))
    ___ContributedExtensionBlock_contributorId_tab_val_Extn_1 = SEQ(name='Extn', mode=MODE_TYPE, typeref=ASN1RefType(('EtsiTs103097ExtensionModule', 'EtsiOriginatingHeaderInfoExtension')))
    __ContributedExtensionBlock_contributorId_tab._val = ASN1Set(rv=[dict([('Extn', ___ContributedExtensionBlock_contributorId_tab_val_Extn_0), ('id', 1)]), dict([('Extn', ___ContributedExtensionBlock_contributorId_tab_val_Extn_1), ('id', 2)])], rr=[], ev=None, er=[])
    ...
    _Ieee1609Dot2HeaderInfoContributedExtensions_val_Extn_0 = SEQ(name='Extn', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2', 'Ieee1609ContributedHeaderInfoExtension')))
    _Ieee1609Dot2HeaderInfoContributedExtensions_val_Extn_1 = SEQ(name='Extn', mode=MODE_TYPE, typeref=ASN1RefType(('EtsiTs103097ExtensionModule', 'EtsiOriginatingHeaderInfoExtension')))
    Ieee1609Dot2HeaderInfoContributedExtensions._val = ASN1Set(rv=[dict([('Extn', _Ieee1609Dot2HeaderInfoContributedExtensions_val_Extn_0), ('id', 1)]), dict([('Extn', _Ieee1609Dot2HeaderInfoContributedExtensions_val_Extn_1), ('id', 2)])], rr=[], ev=[], er=[])
    ...
    #-----< ieee1609HeaderInfoContributorId >-----#
    ieee1609HeaderInfoContributorId = INT(name='ieee1609HeaderInfoContributorId', mode=MODE_VALUE, typeref=ASN1RefType(('Ieee1609Dot2', 'HeaderInfoContributorId')))
    ieee1609HeaderInfoContributorId._val = 1
    ...
    _EncryptedDataEncryptionKey_ecencSm2256 = SEQ(name='ecencSm2256', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'EcencP256EncryptedKey')))
    EncryptedDataEncryptionKey._cont = ASN1Dict([
        ...
        ('ecencSm2256', _EncryptedDataEncryptionKey_ecencSm2256),
        ])
    EncryptedDataEncryptionKey._ext = ['ecencSm2256']
    
    #-----< SymmetricCiphertext >-----#
    SymmetricCiphertext = CHOICE(name='SymmetricCiphertext', mode=MODE_TYPE)
    _SymmetricCiphertext_aes128ccm = SEQ(name='aes128ccm', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2', 'One28BitCcmCiphertext')))
    _SymmetricCiphertext_sm4Ccm = SEQ(name='sm4Ccm', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2', 'One28BitCcmCiphertext')))
    SymmetricCiphertext._cont = ASN1Dict([
        ('aes128ccm', _SymmetricCiphertext_aes128ccm),
        ('sm4Ccm', _SymmetricCiphertext_sm4Ccm),
        ])
    SymmetricCiphertext._ext = ['sm4Ccm']
    
    #-----< One28BitCcmCiphertext >-----#
    One28BitCcmCiphertext = SEQ(name='One28BitCcmCiphertext', mode=MODE_TYPE)
    _One28BitCcmCiphertext_nonce = OCT_STR(name='nonce', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _One28BitCcmCiphertext_nonce._const_sz = ASN1Set(rv=[12], rr=[], ev=None, er=[])
    _One28BitCcmCiphertext_ccmCiphertext = OCT_STR(name='ccmCiphertext', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Opaque')))
    One28BitCcmCiphertext._cont = ASN1Dict([
        ('nonce', _One28BitCcmCiphertext_nonce),
        ('ccmCiphertext', _One28BitCcmCiphertext_ccmCiphertext),
        ])
    One28BitCcmCiphertext._ext = None
    
    #-----< Aes128CcmCiphertext >-----#
    Aes128CcmCiphertext = SEQ(name='Aes128CcmCiphertext', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2', 'One28BitCcmCiphertext')))
    ...
    _IssuerIdentifier_sm3AndDigest = OCT_STR(name='sm3AndDigest', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'HashedId8')))
    IssuerIdentifier._cont = ASN1Dict([
        ...
        ('sm3AndDigest', _IssuerIdentifier_sm3AndDigest),
        ])
    IssuerIdentifier._ext = ['sha384AndDigest', 'sm3AndDigest']
    ...
    _ToBeSignedCertificate_flags = BIT_STR(name='flags', mode=MODE_TYPE, tag=(12, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ToBeSignedCertificate_flags._cont = ASN1Dict([('usesCubk', 0)])
    _ToBeSignedCertificate_flags._const_sz = ASN1Set(rv=[8], rr=[], ev=None, er=[])
    _ToBeSignedCertificate_appExtensions = SEQ_OF(name='appExtensions', mode=MODE_TYPE, tag=(13, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2', 'SequenceOfAppExtensions')))
    _ToBeSignedCertificate_certIssueExtensions = SEQ_OF(name='certIssueExtensions', mode=MODE_TYPE, tag=(14, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2', 'SequenceOfCertIssueExtensions')))
    _ToBeSignedCertificate_certRequestExtension = SEQ_OF(name='certRequestExtension', mode=MODE_TYPE, tag=(15, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2', 'SequenceOfCertRequestExtensions')))
    ToBeSignedCertificate._cont = ASN1Dict([
        ...
        ('flags', _ToBeSignedCertificate_flags),
        ('appExtensions', _ToBeSignedCertificate_appExtensions),
        ('certIssueExtensions', _ToBeSignedCertificate_certIssueExtensions),
        ('certRequestExtension', _ToBeSignedCertificate_certRequestExtension),
        ])
    ToBeSignedCertificate._ext = ['flags', 'appExtensions', 'certIssueExtensions', 'certRequestExtension']
    ...
    #-----< Ieee1609ContributedHeaderInfoExtension >-----#
    Ieee1609ContributedHeaderInfoExtension = SEQ(name='Ieee1609ContributedHeaderInfoExtension', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Extension')))
    _Ieee1609ContributedHeaderInfoExtension_id = INT(name='id', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefClassField(('Ieee1609Dot2BaseTypes', 'EXT-TYPE'), ['extId']))
    __Ieee1609ContributedHeaderInfoExtension_id_tab = CLASS(name='_tab_EXT-TYPE', mode=MODE_SET, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'EXT-TYPE')))
    ___Ieee1609ContributedHeaderInfoExtension_id_tab_val_ExtContent_0 = OCT_STR(name='ExtContent', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'HashedId8')))
    __Ieee1609ContributedHeaderInfoExtension_id_tab._val = ASN1Set(rv=[dict([('ExtContent', ___Ieee1609ContributedHeaderInfoExtension_id_tab_val_ExtContent_0), ('extId', 1)])], rr=[], ev=None, er=[])
    _Ieee1609ContributedHeaderInfoExtension_id._const_tab = __Ieee1609ContributedHeaderInfoExtension_id_tab
    _Ieee1609ContributedHeaderInfoExtension_id._const_tab_at = None
    _Ieee1609ContributedHeaderInfoExtension_id._const_tab_id = 'extId'
    _Ieee1609ContributedHeaderInfoExtension_content = OPEN(name='content', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefClassField(('Ieee1609Dot2BaseTypes', 'EXT-TYPE'), ['ExtContent']))
    _Ieee1609ContributedHeaderInfoExtension_content._const_tab = __Ieee1609ContributedHeaderInfoExtension_id_tab
    _Ieee1609ContributedHeaderInfoExtension_content._const_tab_at = ('..', 'id')
    _Ieee1609ContributedHeaderInfoExtension_content._const_tab_id = 'ExtContent'
    Ieee1609ContributedHeaderInfoExtension._cont = ASN1Dict([
        ('id', _Ieee1609ContributedHeaderInfoExtension_id),
        ('content', _Ieee1609ContributedHeaderInfoExtension_content),
        ])
    Ieee1609ContributedHeaderInfoExtension._ext = None
    
    #-----< Ieee1609HeaderInfoExtensionId >-----#
    Ieee1609HeaderInfoExtensionId = INT(name='Ieee1609HeaderInfoExtensionId', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'ExtId')))
    
    #-----< p2pcd8ByteLearningRequestId >-----#
    p2pcd8ByteLearningRequestId = INT(name='p2pcd8ByteLearningRequestId', mode=MODE_VALUE, typeref=ASN1RefType(('Ieee1609Dot2', 'Ieee1609HeaderInfoExtensionId')))
    p2pcd8ByteLearningRequestId._val = 1
    
    #-----< Ieee1609HeaderInfoExtensions >-----#
    Ieee1609HeaderInfoExtensions = CLASS(name='Ieee1609HeaderInfoExtensions', mode=MODE_SET, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'EXT-TYPE')))
    _Ieee1609HeaderInfoExtensions_val_ExtContent_0 = OCT_STR(name='ExtContent', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'HashedId8')))
    Ieee1609HeaderInfoExtensions._val = ASN1Set(rv=[dict([('ExtContent', _Ieee1609HeaderInfoExtensions_val_ExtContent_0), ('extId', 1)])], rr=[], ev=[], er=[])
    
    #-----< SequenceOfAppExtensions >-----#
    SequenceOfAppExtensions = SEQ_OF(name='SequenceOfAppExtensions', mode=MODE_TYPE)
    _SequenceOfAppExtensions__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2', 'AppExtension')))
    SequenceOfAppExtensions._cont = _SequenceOfAppExtensions__item_
    SequenceOfAppExtensions._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=1, ub=None)], ev=None, er=[])
    
    #-----< AppExtension >-----#
    AppExtension = SEQ(name='AppExtension', mode=MODE_TYPE)
    _AppExtension_id = INT(name='id', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefClassField(('Ieee1609Dot2BaseTypes', 'CERT-EXT-TYPE'), ['id']))
    __AppExtension_id_tab = CLASS(name='_tab_CERT-EXT-TYPE', mode=MODE_SET, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'CERT-EXT-TYPE')))
    ___AppExtension_id_tab_val_App_0 = OID(name='App', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2', 'OperatingOrganizationId')))
    ___AppExtension_id_tab_val_Issue_0 = NULL(name='Issue', mode=MODE_TYPE)
    ___AppExtension_id_tab_val_Req_0 = NULL(name='Req', mode=MODE_TYPE)
    __AppExtension_id_tab._val = ASN1Set(rv=[dict([('id', 1), ('App', ___AppExtension_id_tab_val_App_0), ('Issue', ___AppExtension_id_tab_val_Issue_0), ('Req', ___AppExtension_id_tab_val_Req_0)])], rr=[], ev=None, er=[])
    _AppExtension_id._const_tab = __AppExtension_id_tab
    _AppExtension_id._const_tab_at = None
    _AppExtension_id._const_tab_id = 'id'
    _AppExtension_content = OPEN(name='content', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefClassField(('Ieee1609Dot2BaseTypes', 'CERT-EXT-TYPE'), ['App']))
    _AppExtension_content._const_tab = __AppExtension_id_tab
    _AppExtension_content._const_tab_at = ('..', 'id')
    _AppExtension_content._const_tab_id = 'App'
    AppExtension._cont = ASN1Dict([
        ('id', _AppExtension_id),
        ('content', _AppExtension_content),
        ])
    AppExtension._ext = None
    
    #-----< SequenceOfCertIssueExtensions >-----#
    SequenceOfCertIssueExtensions = SEQ_OF(name='SequenceOfCertIssueExtensions', mode=MODE_TYPE)
    _SequenceOfCertIssueExtensions__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2', 'CertIssueExtension')))
    SequenceOfCertIssueExtensions._cont = _SequenceOfCertIssueExtensions__item_
    SequenceOfCertIssueExtensions._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=1, ub=None)], ev=None, er=[])
    
    #-----< CertIssueExtension >-----#
    CertIssueExtension = SEQ(name='CertIssueExtension', mode=MODE_TYPE)
    _CertIssueExtension_id = INT(name='id', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefClassField(('Ieee1609Dot2BaseTypes', 'CERT-EXT-TYPE'), ['id']))
    __CertIssueExtension_id_tab = CLASS(name='_tab_CERT-EXT-TYPE', mode=MODE_SET, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'CERT-EXT-TYPE')))
    ___CertIssueExtension_id_tab_val_App_0 = OID(name='App', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2', 'OperatingOrganizationId')))
    ___CertIssueExtension_id_tab_val_Issue_0 = NULL(name='Issue', mode=MODE_TYPE)
    ___CertIssueExtension_id_tab_val_Req_0 = NULL(name='Req', mode=MODE_TYPE)
    __CertIssueExtension_id_tab._val = ASN1Set(rv=[dict([('id', 1), ('App', ___CertIssueExtension_id_tab_val_App_0), ('Issue', ___CertIssueExtension_id_tab_val_Issue_0), ('Req', ___CertIssueExtension_id_tab_val_Req_0)])], rr=[], ev=None, er=[])
    _CertIssueExtension_id._const_tab = __CertIssueExtension_id_tab
    _CertIssueExtension_id._const_tab_at = None
    _CertIssueExtension_id._const_tab_id = 'id'
    _CertIssueExtension_permissions = CHOICE(name='permissions', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT))
    __CertIssueExtension_permissions_specific = OPEN(name='specific', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefClassField(('Ieee1609Dot2BaseTypes', 'CERT-EXT-TYPE'), ['Issue']))
    __CertIssueExtension_permissions_specific._const_tab = __CertIssueExtension_id_tab
    __CertIssueExtension_permissions_specific._const_tab_at = ('..', '..', 'id')
    __CertIssueExtension_permissions_specific._const_tab_id = 'Issue'
    __CertIssueExtension_permissions_all = NULL(name='all', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _CertIssueExtension_permissions._cont = ASN1Dict([
        ('specific', __CertIssueExtension_permissions_specific),
        ('all', __CertIssueExtension_permissions_all),
        ])
    _CertIssueExtension_permissions._ext = None
    CertIssueExtension._cont = ASN1Dict([
        ('id', _CertIssueExtension_id),
        ('permissions', _CertIssueExtension_permissions),
        ])
    CertIssueExtension._ext = None
    
    #-----< SequenceOfCertRequestExtensions >-----#
    SequenceOfCertRequestExtensions = SEQ_OF(name='SequenceOfCertRequestExtensions', mode=MODE_TYPE)
    _SequenceOfCertRequestExtensions__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2', 'CertRequestExtension')))
    SequenceOfCertRequestExtensions._cont = _SequenceOfCertRequestExtensions__item_
    SequenceOfCertRequestExtensions._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=1, ub=None)], ev=None, er=[])
    
    #-----< CertRequestExtension >-----#
    CertRequestExtension = SEQ(name='CertRequestExtension', mode=MODE_TYPE)
    _CertRequestExtension_id = INT(name='id', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefClassField(('Ieee1609Dot2BaseTypes', 'CERT-EXT-TYPE'), ['id']))
    __CertRequestExtension_id_tab = CLASS(name='_tab_CERT-EXT-TYPE', mode=MODE_SET, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'CERT-EXT-TYPE')))
    ___CertRequestExtension_id_tab_val_App_0 = OID(name='App', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2', 'OperatingOrganizationId')))
    ___CertRequestExtension_id_tab_val_Issue_0 = NULL(name='Issue', mode=MODE_TYPE)
    ___CertRequestExtension_id_tab_val_Req_0 = NULL(name='Req', mode=MODE_TYPE)
    __CertRequestExtension_id_tab._val = ASN1Set(rv=[dict([('id', 1), ('App', ___CertRequestExtension_id_tab_val_App_0), ('Issue', ___CertRequestExtension_id_tab_val_Issue_0), ('Req', ___CertRequestExtension_id_tab_val_Req_0)])], rr=[], ev=None, er=[])
    _CertRequestExtension_id._const_tab = __CertRequestExtension_id_tab
    _CertRequestExtension_id._const_tab_at = None
    _CertRequestExtension_id._const_tab_id = 'id'
    _CertRequestExtension_permissions = CHOICE(name='permissions', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT))
    __CertRequestExtension_permissions_content = OPEN(name='content', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefClassField(('Ieee1609Dot2BaseTypes', 'CERT-EXT-TYPE'), ['Req']))
    __CertRequestExtension_permissions_content._const_tab = __CertRequestExtension_id_tab
    __CertRequestExtension_permissions_content._const_tab_at = ('..', '..', 'id')
    __CertRequestExtension_permissions_content._const_tab_id = 'Req'
    __CertRequestExtension_permissions_all = NULL(name='all', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _CertRequestExtension_permissions._cont = ASN1Dict([
        ('content', __CertRequestExtension_permissions_content),
        ('all', __CertRequestExtension_permissions_all),
        ])
    _CertRequestExtension_permissions._ext = None
    CertRequestExtension._cont = ASN1Dict([
        ('id', _CertRequestExtension_id),
        ('permissions', _CertRequestExtension_permissions),
        ])
    CertRequestExtension._ext = None
    
    #-----< OperatingOrganizationId >-----#
    OperatingOrganizationId = OID(name='OperatingOrganizationId', mode=MODE_TYPE)
    
    #-----< certExtId-OperatingOrganization >-----#
    certExtId_OperatingOrganization = INT(name='certExtId-OperatingOrganization', mode=MODE_VALUE, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'ExtId')))
    certExtId_OperatingOrganization._val = 1
    
    #-----< instanceOperatingOrganizationCertExtensions >-----#
    instanceOperatingOrganizationCertExtensions = CLASS(name='instanceOperatingOrganizationCertExtensions', mode=MODE_VALUE, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'CERT-EXT-TYPE')))
    _instanceOperatingOrganizationCertExtensions_val_App = OID(name='App', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2', 'OperatingOrganizationId')))
    _instanceOperatingOrganizationCertExtensions_val_Issue = NULL(name='Issue', mode=MODE_TYPE)
    _instanceOperatingOrganizationCertExtensions_val_Req = NULL(name='Req', mode=MODE_TYPE)
    instanceOperatingOrganizationCertExtensions._val = dict([('id', 1), ('App', _instanceOperatingOrganizationCertExtensions_val_App), ('Issue', _instanceOperatingOrganizationCertExtensions_val_Issue), ('Req', _instanceOperatingOrganizationCertExtensions_val_Req)])
    
    #-----< SetCertExtensions >-----#
    SetCertExtensions = CLASS(name='SetCertExtensions', mode=MODE_SET, typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'CERT-EXT-TYPE')))
    _SetCertExtensions_val_App_0 = OID(name='App', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2', 'OperatingOrganizationId')))
    _SetCertExtensions_val_Issue_0 = NULL(name='Issue', mode=MODE_TYPE)
    _SetCertExtensions_val_Req_0 = NULL(name='Req', mode=MODE_TYPE)
    SetCertExtensions._val = ASN1Set(rv=[dict([('id', 1), ('App', _SetCertExtensions_val_App_0), ('Issue', _SetCertExtensions_val_Issue_0), ('Req', _SetCertExtensions_val_Req_0)])], rr=[], ev=[], er=[])
    ...
    _all_ = [
        ...
        _Ieee1609Dot2Content_signedX509CertificateRequest,
        Ieee1609Dot2Content,
        _SignedData_hashId,
        _SignedData_tbsData,
        _SignedData_signer,
        ...
        ___ContributedExtensionBlock_contributorId_tab_val_Extn_1,
        ...
        _Ieee1609Dot2HeaderInfoContributedExtensions_val_Extn_1,
        HeaderInfoContributorId,
        ieee1609HeaderInfoContributorId,
        etsiHeaderInfoContributorId,
        ...
        _EncryptedDataEncryptionKey_ecencSm2256,
        EncryptedDataEncryptionKey,
        _SymmetricCiphertext_aes128ccm,
        _SymmetricCiphertext_sm4Ccm,
        SymmetricCiphertext,
        _One28BitCcmCiphertext_nonce,
        _One28BitCcmCiphertext_ccmCiphertext,
        One28BitCcmCiphertext,
        Aes128CcmCiphertext,
        Certificate,
        TestCertificate,
        ...
        _IssuerIdentifier_sm3AndDigest,
        IssuerIdentifier,
        ...
        _ToBeSignedCertificate_flags,
        _ToBeSignedCertificate_appExtensions,
        _ToBeSignedCertificate_certIssueExtensions,
        _ToBeSignedCertificate_certRequestExtension,
        ToBeSignedCertificate,
        ...
        VerificationKeyIndicator,
        __Ieee1609ContributedHeaderInfoExtension_id_tab,
        ___Ieee1609ContributedHeaderInfoExtension_id_tab_val_ExtContent_0,
        _Ieee1609ContributedHeaderInfoExtension_id,
        _Ieee1609ContributedHeaderInfoExtension_content,
        Ieee1609ContributedHeaderInfoExtension,
        Ieee1609HeaderInfoExtensionId,
        p2pcd8ByteLearningRequestId,
        Ieee1609HeaderInfoExtensions,
        _Ieee1609HeaderInfoExtensions_val_ExtContent_0,
        _SequenceOfAppExtensions__item_,
        SequenceOfAppExtensions,
        __AppExtension_id_tab,
        ___AppExtension_id_tab_val_App_0,
        ___AppExtension_id_tab_val_Issue_0,
        ___AppExtension_id_tab_val_Req_0,
        _AppExtension_id,
        _AppExtension_content,
        AppExtension,
        _SequenceOfCertIssueExtensions__item_,
        SequenceOfCertIssueExtensions,
        __CertIssueExtension_id_tab,
        ___CertIssueExtension_id_tab_val_App_0,
        ___CertIssueExtension_id_tab_val_Issue_0,
        ___CertIssueExtension_id_tab_val_Req_0,
        _CertIssueExtension_id,
        __CertIssueExtension_permissions_specific,
        __CertIssueExtension_permissions_all,
        _CertIssueExtension_permissions,
        CertIssueExtension,
        _SequenceOfCertRequestExtensions__item_,
        SequenceOfCertRequestExtensions,
        __CertRequestExtension_id_tab,
        ___CertRequestExtension_id_tab_val_App_0,
        ___CertRequestExtension_id_tab_val_Issue_0,
        ___CertRequestExtension_id_tab_val_Req_0,
        _CertRequestExtension_id,
        __CertRequestExtension_permissions_content,
        __CertRequestExtension_permissions_all,
        _CertRequestExtension_permissions,
        CertRequestExtension,
        OperatingOrganizationId,
        certExtId_OperatingOrganization,
        instanceOperatingOrganizationCertExtensions,
        _instanceOperatingOrganizationCertExtensions_val_App,
        _instanceOperatingOrganizationCertExtensions_val_Issue,
        _instanceOperatingOrganizationCertExtensions_val_Req,
        SetCertExtensions,
        _SetCertExtensions_val_App_0,
        _SetCertExtensions_val_Issue_0,
        _SetCertExtensions_val_Req_0,
    ]

class Ieee1609Dot2Peer2Peer:

    _name_  = 'Ieee1609Dot2Peer2Peer'
    _oid_   = [1, 3, 111, 2, 1609, 2, 2, 1, 2, 3]
    ...
    #-----< Ieee1609dot2Peer2PeerPDU >-----#
    Ieee1609dot2Peer2PeerPDU = SEQ(name='Ieee1609dot2Peer2PeerPDU', mode=MODE_TYPE)
    _Ieee1609dot2Peer2PeerPDU_version = INT(name='version', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2BaseTypes', 'Uint8')))
    _Ieee1609dot2Peer2PeerPDU_version._const_val = ASN1Set(rv=[1], rr=[], ev=None, er=[])
    _Ieee1609dot2Peer2PeerPDU_content = CHOICE(name='content', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT))
    __Ieee1609dot2Peer2PeerPDU_content_caCerts = SEQ_OF(name='caCerts', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('Ieee1609Dot2Peer2Peer', 'CaCertP2pPDU')))
    _Ieee1609dot2Peer2PeerPDU_content._cont = ASN1Dict([
        ('caCerts', __Ieee1609dot2Peer2PeerPDU_content_caCerts),
        ])
    _Ieee1609dot2Peer2PeerPDU_content._ext = []
    Ieee1609dot2Peer2PeerPDU._cont = ASN1Dict([
        ('version', _Ieee1609dot2Peer2PeerPDU_version),
        ('content', _Ieee1609dot2Peer2PeerPDU_content),
        ])
    Ieee1609dot2Peer2PeerPDU._ext = None
    
    #-----< CaCertP2pPDU >-----#
    CaCertP2pPDU = SEQ_OF(name='CaCertP2pPDU', mode=MODE_TYPE)
    _CaCertP2pPDU__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('Ieee1609Dot2', 'Certificate')))
    CaCertP2pPDU._cont = _CaCertP2pPDU__item_
    
    _all_ = [
        _Ieee1609dot2Peer2PeerPDU_version,
        __Ieee1609dot2Peer2PeerPDU_content_caCerts,
        _Ieee1609dot2Peer2PeerPDU_content,
        Ieee1609dot2Peer2PeerPDU,
        _CaCertP2pPDU__item_,
        CaCertP2pPDU,
    ]

init_modules(Ieee1609Dot2CrlBaseTypes, Ieee1609Dot2BaseTypes, EtsiTs103097ExtensionModule, Ieee1609Dot2CrlSsp, Ieee1609Dot2Crl, Ieee1609Dot2, Ieee1609Dot2Peer2Peer)
